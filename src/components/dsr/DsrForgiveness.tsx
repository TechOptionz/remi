...
import { Body, Box, H3, Hand, Panel, Part } from '@/components/ideas/ui';
import { HELD_WORK } from '@/content/dsr';

// SELF-FORGIVENESS WITHOUT EXCUSING HARM + A MODEL THAT CAN HOLD OTHER DEEP WORK
export default function DsrForgiveness() {
  return (
    <Part n={5}>
      <Panel tone="dark" className="centre-panel real-panel">
        <H3 className="panel-title centre-title">Self-forgiveness without excusing harm</H3>
      ...
      <H3 v={['left', 'rule']}>A model that can hold other deep work</H3>
