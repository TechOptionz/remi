...
// THE EXTERNAL DIFFICULTY CAN STILL BE REAL — illness, abuse and the care this distinction needs
export default function SafeReal() {
  return (
    <Part n={5}>
      <Panel tone="dark" className="centre-panel real-panel">
        <H3 className="panel-title centre-title">The external difficulty can still be real</H3>
