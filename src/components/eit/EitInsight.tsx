...
// WHY UNDERSTANDING YOUR PATTERNS DOES NOT ALWAYS HELP YOU FEEL — parts work, the limit of asking for compassion, the part that would not step aside
export default function EitInsight() {
  return (
    <Part n={2}>
      <H3 v={['left', 'rule']}>Why understanding your patterns does not always help you feel</H3>
