...
import { Body, Hand, HeadNote, Part, PartHead } from '@/components/ideas/ui';
...
// THE CRITICAL ALIGNMENT MODEL — breadcrumb, title, where performance problems get diagnosed, why CAM exists, the diagram
export default function CamIntro() {
  return (
    <Part n={1} className="triad-intro">
      ...
      <PartHead n={1} note title="The Critical Alignment Model"
        aside={<HeadNote art="p5-arrow" className="cam-head-note"><Hand>A way to think<br />before reacting.</Hand></HeadNote>}>
      ...
      <ZoomArt name="cam-model" alt={CAM_ALT} label="the Critical Alignment Model" className="triad-diagram cam-plate" />
      <p className="dsr-caption">The Critical Alignment Model developed by Remi Pearson</p>
    </Part>
  );
}
