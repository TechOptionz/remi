...
const TOPICS: { icon: IconName; title: string; text: React.ReactNode }[] = [
  ...
  { icon: 'people', title: 'Leadership, culture & senior team facilitation', text: <>Disruptive Leadership, <Link href="/ideas-models#part-6">T.R.U.S.T.M.E.</Link>, accountability, healthy culture and holding the room when difficult conversations and consequential decisions matter.</> },
