...
## Where things live
- `src/app/<route>/page.tsx` — one file per page. It only lists that page's sections in order and sets the page title/description. Routes: `/`, `/perspectives`, `/about-remi`, `/ideas-models`, `/trustme-model`, `/programs`, `/invite-remi`.
