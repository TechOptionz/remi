...
export const GLANCE: { name: string; href: string; art: string; cards: GlanceCard[] }[] = [
  ...
  { name: 'Leadership & evolution', href: '#part-6', art: 'p2-v4', cards: [
    { href: '/trustme-model', icon: 'team', title: 'T.R.U.S.T.M.E.', question: 'What operating logic is this person, team or organisation using?' },
...
export const NEXT_STEPS = [
  { art: 'p9-mic', title: 'Watch Perspectives', text: 'Come for the conversation. Stay for the question.', cta: 'Watch or listen', href: '/#rabbit-holes' },
