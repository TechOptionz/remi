...
export default function NewsletterForm({ variant = 'footer' }: { variant?: 'footer' | 'keep' }) {
  ...
  return (
    <form className={variant === 'keep' ? 'news-form keep-form' : 'news-form'} onSubmit={e => { e.preventDefault(); submitLead('newsletter', e.currentTarget); setSent(true); }}>
      {variant === 'footer' && (
        <>
